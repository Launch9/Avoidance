...
Sub_NPC_A_temp::Sub_NPC_A_temp(int Type, int x_pos, int y_pos, TileMap &TM)
{
	type = Type;
	x = x_pos;
	y = y_pos;
...
void Sub_NPC_A_temp::tick(bool render) {
...
void Sub_NPC_A_temp::ifPlayerMoved(int speed, int direction, int spaces, float remainder) {
	if (isPaused == false) {
